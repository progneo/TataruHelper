...
> 포크 안내: 이 저장소는 현재도 활발히 유지보수되는 포크입니다.
>
> - 원본 저장소: https://github.com/NightlyRevenger/TataruHelper
...
## [바로 다운로드하기](https://github.com/progneo/TataruHelper/releases/latest/download/Setup.exe) (Setup.exe)
...
## [기부하기](https://github.com/progneo/TataruHelper/blob/master/README.md#support)
...
Tataru Helper는 Windows 7 이상 (**64bit**), [Microsoft .NET 10 ](https://dotnet.microsoft.com/ru-ru/download) 이상, **DirectX 11** 모드로 실행되는 Final Fantasy XIV 클라이언트가 필요합니다.

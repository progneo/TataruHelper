...
namespace Translation.Providers.Papago
{
    ...
    {
        [JsonProperty("stringReqv")] public string EncodedTranslationRequest { get; set; }

        [JsonProperty("hmacKey")] public string HmacKey { get; set; }

        [JsonProperty("hmacInput")] public string HmacInput { get; set; }

        [JsonProperty("guid")] public Guid Guid { get; set; }

        [JsonProperty("guidTime")] public string GuidTime { get; set; }
    }
